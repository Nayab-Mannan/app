...
const DATA1: Datatable[] = [
  {nm:'MPR', output: 'PC3', model: '60%',model1: '10 folds',model2: '2 ',time:'2 min' },
  {nm:'MPR', output: 'PC3', model: '60%',model1: '10 folds',model2: '2',time:'2 min' },
  {nm:'MPR', output: 'PC3', model: '60%',model1: '10 folds',model2: '2',time:'2 min' },
  {nm:'MPR', output: 'PC3', model: '60%',model1: '10 folds',model2: '2',time:'2 min' },
  {nm:'MPR', output: 'PC3', model: '60%',model1: '10 folds',model2: '2',time:'2 min' },
...
@Component({
  selector: 'app-template-second',
  templateUrl: './template-second.component.html',
  styleUrls: ['./template-second.component.css']
})
export class TemplateSecondComponent implements OnInit {
  ...
  displayedColumns2: string[] =  ['nm', 'output', 'model', 'model1', 'model2', 'time'];
  dataSource2 = DATA1;
